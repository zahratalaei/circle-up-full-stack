    ...
    return (
        <div className='p-4 bg-white shadow-md text-sm mx-2 rounded-lg flex flex-col gap-4'>
            ...
            <div className={`flex flex-col  text-gray-500 ${size === "sm" ? "gap-2" : size === "md" ? "gap-4" : "gap-6"}`}>
                ...
                <button className="bg-secondary text-gray-600 p-2 text-xs rounded-lg cursor-pointer hover:bg-primary transition-transform duration-200 hover:scale-105  hover:text-gray-800">Learn more</button>
            </div>
        </div>
    )
} 
