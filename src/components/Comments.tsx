    ...
    return (
        <div>
            ...
            <div className='flex items-center gap-4'>
                ...
                <div className='flex items-center justify-between bg-muted w-full p-2 rounded-xl text-sm flex-1'>
            ...
            <div >
                ...
                <div className='flex gap-4 justify-between mt-6' >
                    {/* Avatar */}
                    <Image src="https://images.pexels.com/photos/432059/pexels-photo-432059.jpeg?auto=compress&cs=tinysrgb&w=1200" alt="" className='w-10 h-10 rounded-full object-cover icon-primary' width={40} height={40} />
                    {/* Desc */}
